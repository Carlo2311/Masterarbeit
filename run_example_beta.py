...
# import tikzplotlib
from analytical_example_beta import AnalyticalExample
...
np.save(fr'C:/Users/carlo/Masterarbeit/Masterarbeit/solutions_example_beta/c_{n_samples}_p{p}_nq{N_q}_sigma{sigma_noise}.npy', optimized_c)
...
spce.plot_distribution(dist_spce, y, pdf_test, samples_x_test, samples_y_test, mean_test, sigma_test)
