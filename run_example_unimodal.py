...
dist_gpr = spce.plot_distribution(dist_spce, y, pdf_test, samples_x_test, samples_y_test, mean_test, sigma_test)

error_n = spce.compute_error(dist_spce, samples_y_test, dist_gpr)
print('error = ', error_n)
